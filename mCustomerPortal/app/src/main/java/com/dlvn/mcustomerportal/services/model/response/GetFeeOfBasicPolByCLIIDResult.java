...
public class GetFeeOfBasicPolByCLIIDResult {
    ...
    @Expose
    private List<FeeBasicOfPolicy> lstFeeBasic = null;
    ...
    public List<FeeBasicOfPolicy> getLstFeeBasic() {
        return lstFeeBasic;
    }

    public void setLstFeeBasic(List<FeeBasicOfPolicy> lstFeeBasic) {
        this.lstFeeBasic = lstFeeBasic;
    }
}
